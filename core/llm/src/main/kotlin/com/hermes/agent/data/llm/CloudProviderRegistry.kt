...
object CloudProviderRegistry {
    val providers: List<CloudProviderDefinition> = listOf(
        ...
        CloudProviderDefinition("groq", "Groq", "Low-latency hosted open models", "https://api.groq.com/openai/v1", "openai/gpt-oss-120b", 0.88, 0.10, 0.98, 0.94, supportsVision = true),
        CloudProviderDefinition("mistral", "Mistral AI", "Mistral's direct model API", "https://api.mistral.ai/v1", "mistral-large-latest", 0.70, 0.20, 0.82, 0.90, supportsVision = true),
        CloudProviderDefinition("kilo", "Kilo Code", "Coding-model gateway", "https://api.kilo.ai/api/openrouter", "openai/gpt-4.1-mini", 0.94, 0.05, 0.62, 0.94, supportsVision = true),
        ...
        CloudProviderDefinition("gemini", "Google Gemini", "Google Gemini via OpenAI-compatible endpoint", "https://generativelanguage.googleapis.com/v1beta/openai/", "gemini-2.5-flash", 0.95, 0.05, 0.85, 0.94, supportsVision = true),
        CloudProviderDefinition("ollama-cloud", "Ollama Cloud", "Ollama cloud-hosted models", "https://api.ollama.com/v1", "llama3.2", 0.80, 0.05, 0.65, 0.82, supportsVision = true),
        ...
        CloudProviderDefinition("chutes", "Chutes.ai", "Chutes decentralized serverless AI", "https://api.chutes.ai/v1", "default", 0.75, 0.05, 0.65, 0.80, supportsVision = true),
    )
